...
export function Hero() {
  ...
  return (
    <section
      ref={container}
      className="relative w-full h-svh flex flex-col items-center justify-center overflow-hidden bg-background -mt-16"
    >
      ...
      <div className="absolute inset-x-0 bottom-0 z-10 h-full flex items-end justify-center pointer-events-none">
        <Image
          ...
          width={1000}
          height={1000}
          className="object-contain object-bottom h-[80svh] md:h-svh w-auto max-w-none md:max-w-full drop-shadow-2xl grayscale translate-x-4 md:translate-x-24 lg:translate-x-[20vw]"
          priority
        />
      </div>
