...
describe('TechStack', () => {
  it('renders technical stack categories', () => {
    ...
    expect(screen.getByText(/Soft Skills/i)).toBeDefined();
  });
  ...
  it('renders skills for the default expanded category', () => {
    ...
    // Act & Assert
    expect(screen.getByText('React.js / Next.js')).toBeDefined();
    expect(screen.getByText('TypeScript / JavaScript')).toBeDefined();
  });
  ...
  it('toggles category expansion on click', () => {
    ...
    expect(screen.queryByText('React.js / Next.js')).toBeNull();
